...
public class LivroDAO extends ConexaoDao {
    ...
    public String incluiLivro(Livro livro) throws Exception {
    ...
    public String devolverLivro(int codBarra) throws Exception {
        String retorno = estaEmprestado(codBarra);
        if (!"".equals(retorno)) {
            return retorno;
        }

        Connection conn = novaConexao();
        String sql = "delete from emprestimo where COD_BARRAS = ?";
    ...
    private String estaEmprestado(int codBarras) throws Exception {
